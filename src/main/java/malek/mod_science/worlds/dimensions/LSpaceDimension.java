...
import malek.mod_science.worlds.biomes.VoidChunkGenerator;
...
public class LSpaceDimension {
    ...
    public static void init() {
        Registry.register(Registry.CHUNK_GENERATOR, new Identifier(MOD_ID, "l_space"), VoidChunkGenerator.CODEC);
