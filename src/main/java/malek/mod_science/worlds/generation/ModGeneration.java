...
public class ModGeneration {
    ...
    public static final ConfiguredFeature<?, ?> CONFIGURED_FRACTAL_ORE_GEN = FRACTAL_ORE_GEN.configure(new OreFeatureConfig(OreFeatureConfig.Rules.STONE_ORE_REPLACEABLES, ModBlocks.FRACTAL_ORE.getDefaultState(), 8)).triangleRange(YOffset.fixed(50), YOffset.fixed(150)).repeat(8).spreadHorizontally();
