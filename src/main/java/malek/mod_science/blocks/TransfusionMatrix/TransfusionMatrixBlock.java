...
public class TransfusionMatrixBlock extends ModBlockWithEntity implements BlockEntityProvider, InventoryProvider, AttributeProvider {
    public TransfusionMatrixBlock(Settings settings) {
        super(settings);
...
//            }
    ...
    public void addAllAttributes(World world, BlockPos pos, BlockState state, AttributeList<?> to) {
        ...
        if (blockEntity instanceof TransfusionMatrixBlockEntity) {
            to.offer((((TransfusionMatrixBlockEntity) blockEntity).fluidInv));
        }
    }
    @Override
