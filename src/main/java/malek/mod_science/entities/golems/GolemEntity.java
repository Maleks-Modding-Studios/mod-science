...
public abstract class GolemEntity extends PathAwareEntity implements GolemInventory {
    ...
    protected GolemEntity(EntityType<? extends PathAwareEntity> entityType, World world, Block golemBlock, int inventorySize) {
