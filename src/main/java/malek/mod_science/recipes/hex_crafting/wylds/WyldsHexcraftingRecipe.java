...
public class WyldsHexcraftingRecipe implements Recipe<TesseractInventory> {
    public final ArrayList<Ingredient> ingredients;
    public final ItemStack result;
    public final int TICKS;
    private final Identifier id;

    public WyldsHexcraftingRecipe(ArrayList<Ingredient> ingredients, ItemStack result, int ticks, Identifier id) {
    ...
    public RecipeSerializer<?> getSerializer() {
        return WyldsHexcraftingRecipeSerializer.INSTANCE;
    }


    @Override
    public RecipeType<?> getType() {
        return WyldsType.INSTANCE;
    }
}
