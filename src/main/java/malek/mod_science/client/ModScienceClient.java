...
public class ModScienceClient implements ClientModInitializer, LoggerInterface {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GLIMMERROOT, RenderLayer.getCutout());
        ...
        setupFluidRendering(ModFluids.STILL_OIL, ModFluids.FLOWING_OIL, new Identifier(MOD_ID, "oil"), 0xDFC42A, "fluid");
