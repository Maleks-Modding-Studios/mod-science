...
public class ModFluidBlocks {
    ...
    public static FluidBlock SHADOWFLUID;
    ...
    public static void init() {
        ...
        OIL = Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "oil"), new FluidBlock(STILL_OIL, FabricBlockSettings.of(Material.WATER).noCollision().strength(100.0F).dropsNothing().luminance(0)){});
        ...
        SHADOWFLUID = Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "shadow_fluid"), new FluidBlock(STILL_SHADOW, FabricBlockSettings.of(Material.WATER).noCollision().strength(100.0F).dropsNothing().luminance(0)){});
